...
if makeSmsplFitsFig
    ...
    % save(fullfile(dataDirectory,'percFits_nonparam_tzOnly.mat'), ...
...
save(fullfile(dataDirectory,'percFits_nonparam_tzOnly.mat'),'smsplFits', ...
    'l','D','percDataUsed','percTypeChoice','numPercTypesChosen', ...
    'numNetTypes','astralNumList','to50')


threshPlot = figure(2); clf;
...
exportgraphics(threshPlot,fullfile(figDirectory,['percCrit','.pdf']), ...
    'ContentType','Vector')

%% Correlation between deltaRho and moduli
% 
% example code copied from percCrit_eqSpaced
%
% % shear modulus sweep
% load(fullfile(dataDirectory,'rf_shear_eq_physio251001_l0.1_D1.mat'), ...
