% Apply tension to an astral network
% Many random seeds, selected astral numbers
% Brady Berg, 2025-10-16
...
set simul system
{
    ...
    verbose = 0
    % number of replicates (different seeds) specified in run_modulus_distr_tens.sh
...
set fiber actin
{
    rigidity       = 0.01   % old 20 --> new 0.01 pN*um^2
...
% run system with no force; allows crosslinkers to bind filaments together
run system
{
    nb_steps = 500
    nb_frames = 5
