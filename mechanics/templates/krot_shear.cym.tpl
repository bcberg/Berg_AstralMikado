...
% sweep over angular stiffness at astral centers
set simul system
{
    time_step = 0.1
...
% define angular stiffness sweep
[[krot = [50*i for i in range(9)]]]

set aster actinNode
{
    stiffness = 500, [[krot]]   % stiffness1 (pins filament ends at center), stiffness2 (provides torque)
}
