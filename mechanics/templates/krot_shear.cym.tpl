...
% Vary angular stiffness at astral centers
...
[[krot = [100*i for i in range(11)]]]
set aster actinNode
{
    stiffness = 1000, [[krot]]   % stiffness1 (pins filament ends at center), stiffness2 (provides torque)
}
...
[[nFilPerAster = [1,2,3,4,5,6,8,12,16,20,24]]]
...
[[crosslinker_dens_bulk = 225]]
new [[crosslinker_dens_bulk * D**2]] crosslinker
...
% total crosslinker density: [[crosslinker_dens_bulk + 20/D]]
